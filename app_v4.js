...
${(data.rendementActive && (data.pause || (data.reprise && data.fin) || paidAbsenceExtra > 0 || recoverExtra > 0 || legalDayMinutes > 0)) ?
                ...
                `${(data.rendementActive && (data.arrivee || data.status === "present") && (!data.pause && !(data.reprise && data.fin) && paidAbsenceExtra === 0 && recoverExtra === 0 && legalDayMinutes === 0 && legalNightMinutes === 0)) ?
                    `<td class="total-cell val-total-jour" data-col-group="col-totaux">${minutesToHoursStr(legalDayMinutes)}</td>
                      <td class="total-cell val-total-nuit" data-col-group="col-totaux">${minutesToHoursStr(legalNightMinutes)}</td>
        ...
        if (synthTbody) {
            ...
            trSynth.innerHTML = `
                ...
                ${data.rendementActive && (data.pause || (data.reprise && data.fin) || paidAbsenceExtra > 0 || recoverExtra > 0 || legalDayMinutes > 0 || legalNightMinutes > 0) ?
